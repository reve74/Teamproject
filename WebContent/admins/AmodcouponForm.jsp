					...
					<div class="container-fluid" style="width: 70%;">
						...
						<table class="table table-bordered table-head-bg-info table-bordered-bd-info mt-4">
											...
											<tbody>
												...
												<tr align="center">
												<td><b>내용</b></td>
												<td colspan="4"><textarea name="content" class="form-control" id="comment" rows="20">${couponBean.event_content }</textarea></td>
												</tr>
												<tr align="center">
												<td><b>이벤트 기간</b></td>
												<td colspan="4" align="center">
												<input type="date" name="startdate" style="width: 30%;" value="${couponBean.event_startdate}">
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;~
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="date" name="enddate" style="width: 30%;" value="${couponBean.event_enddate}">
												</td>
												</tr>
												<tr align="center">
												 ...
												 <input class="custom-file-input" type="file" id="e_file1" name="timage" onchange="URL1(this)" accept="image/*" value="../upload/${couponBean.event_timage}">
												...
												<tr align="center">
												 ...
												 <input class="custom-file-input" type="file" id="e_file2"name="image" onchange="URL2(this)" accept="image/*" value="../upload/${couponBean.event_image}">
										...
										<div align="center">
											<button type="submit" class="btn btn-success">쿠폰 수정</button>
