			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid" style="width: 70%;">
						<h4 class="page-title">이벤트 수정</h4>
			
						<form action="${contextPath}/admin/AmodEvent.do?e_num=${event.e_num}" enctype="multipart/form-data" method="post">
						<table class="table table-bordered table-head-bg-info table-bordered-bd-info mt-4">
											...
											<tbody>
												<tr align="center">
													...
													<td colspan="3">
													<input type="text" name="e_title" class="form-control" id="email" value="${event.e_title}" placeholder="이벤트 명" style="width: 75%">
													</td>
												</tr>
												<tr align="center">
												<td><b>내용</b></td>
												<td colspan="4"><textarea name="e_content" class="form-control" id="comment" rows="20">${event.e_content}</textarea></td>
												</tr>
												<tr align="center">
												<td><b>이벤트 기간</b></td>
												<td colspan="4" align="center">
												<input type="date" name="e_startdate" style="width: 30%;" value="${event.e_startdate}">
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;~
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="date" name="e_enddate" style="width: 30%;" value="${event.e_enddate}">
												</td>
												</tr>
												<tr align="center">
												...
												<tr align="center">
													...
													<td id="del" colspan="2" ><img src="${contextPath}/event/image/${event.e_file}"></td>	
												</tr>
												</tbody>
										</table>
										<div align="center">
											<button type="submit" class="btn btn-success">이벤트 수정</button>
