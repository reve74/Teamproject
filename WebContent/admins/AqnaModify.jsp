			...
			<div class="container-fluid">
				...
				<form action="${contextPath}/admin/AmodNotice.do?n_num=${notice.n_num}&check=1" method="POST">
					<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="title" id="title" name="n_title" required value="${qnaUpdate.qna_title}">
					</div>
<!-- 					<div class="form-group"> -->
...
<!-- 					</div> -->
					<div class="form-group">
						...
						<textarea id="summernote" class="form-control" rows="5" name="n_content" >
						 <p>${qnaUpdate.answer}</p>
<!-- 						 <p id="test5"></p> -->
						 </textarea>
					</div>
					<div align="center">
