      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <br><br>
            <input type="button" onclick="location.href='${contextPath}/admin/MemberModify.do'" value="회원 정보 조회  |  수정 " class="btn btn-primary py-3 px-5">
            <br><br>
            <input type="button" onclick="location.href='${contextPath}/admin/MemberJoinCount.do'" value="회원 가입 현황" class="btn btn-primary py-3 px-5">
            <br><br>
