...
var idx = false;
 ...
 function checkId(){
	 ...
	 if(!regId.test(id)){
		 ...
		 checkSpan4.html("<font color='blue'><b>사용가능한 아이디 입니다.</b></font><font color='red'><b>중복확인</font><font color='blue'>을 해주세요.</b></font>");
	...
	if(id == ""){
		...
		$.ajax({
			...
			success : function(result1){
				var str1;
				if(result1 == "false"){
					str1 = "<font color='blue'><b>중복확인이 완료되었습니다.</b></font>";
					$('#checkId').html(str1);
					idx=true;
				}else{
