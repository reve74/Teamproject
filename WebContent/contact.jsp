...
<html>
      ...
      <div class="container">
        <div class="row block-9">
	            ...
	            <div class="col-md-12 mb-3">
	              <p style="font-size: 16px;"><a href="#">마이 페이지</a></p>
	            </div>
	            <div class="col-md-12 mb-3">
	              <p style="font-size: 16px;"><a href="#">프로필 이미지</a></p>
	            </div>
	            <div class="col-md-12 mb-3">
	              <p style="font-size: 16px;"><a href="#">배송지 관리</a></p>
	            </div>
	            <div class="col-md-12 mb-3">
 ...
 <table border="1" font-size="30px"  style="width:50%; margin: 100px; text-align: center;" >
         ...
         <tbody>
        <tr>
          <td width="50%;" height="300px;" ><img src="images/profile.jpg" alt="프로필 이미지" style="max-width: 250px;"></td>
          <td>예매 내역</td>
